...
class Test_speexdec_mode:
    def test(self):
        ...
        answer_path='answers/speex/speex-1.1.12/speexdec/'
        name='speex-1.1.12_speexdec_mode'
        logfile_path="gdb_logs/speex/speex-1.1.12/speexdec/gdb-speex-1.1.12_speexdec_mode.txt"
        c_proj_path='gdb_logs/speex/speex-1.1.12/speex-1.1.12'
