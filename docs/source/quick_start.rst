...
3. Run the Modified Script
	...
	It executes `gdb <https://www.gnu.org/software/gdb/>` ``next`` command when meeting lines which contains library or system call site, other cases it executes ``step`` command of `gdb <https://www.gnu.org/software/gdb/>`.
